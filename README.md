...
Задание курса Highload третьего семестра <a href="https://park.mail.ru/curriculum/program/main/">основной программы Технопарка Mail.ru</a>. Требовалость создать архитектуру сервиса и вычислить количество оборудования, необходимое для создания сервиса, покрывающего 30% выбранного рынка. 
### 1 Тема  
VPN provider.  
